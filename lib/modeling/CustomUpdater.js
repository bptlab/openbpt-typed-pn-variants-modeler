...
import { center, getBusinessObject, is, ifModelElement } from "../util/Util";
...
export default class CustomUpdater extends CommandInterceptor {
  constructor(eventBus, customElementFactory, connectionDocking, translate) {
    ...
    this.executed(["connection.create"], ifModelElement(createArcInscription));
