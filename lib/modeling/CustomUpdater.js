...
import { getArcColor } from "../declarations-panel/provider/properties/Util";
    ...
    if (!arc.businessObject.inscription) {
      ...
      if (arcColor && arcColor.length) {
        arcColor.forEach((dataClass) => {
          const inscriptionElement = this._customElementFactory.create(
          ...
          inscriptionElement.$parent = newInscription;
