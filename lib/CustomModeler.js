...
import ContextPadsModule from "./simulation/context-pads";
...
import UndoModule from "./simulation/undo";

import emptyDiagram from "./util/emptyDiagram";

export default class CustomModeler extends BaseViewer {
  constructor(options) {
    const { container, declarationsPanel, additionalModules = [] } = options;
