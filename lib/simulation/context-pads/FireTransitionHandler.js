...
export class FireTransitionHandler extends CommandInterceptor {
  ...
  async triggerTransition(transition) {
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ...
          <div class="bts-fire-fields"></div>
              <div style="text-align:right;margin-top:6px;">
                ...
                <button class="bts-fire-fast" style="margin-right:8px;">Fast fire</button>
    ...
    // layout fields as rows: label on the left, select on the right
    ...
    // ensure each direct child is a row (label left, select right)
    Array.from(fieldsContainer.children).forEach((child) => {
      ...
      if (sel && sel.style) sel.style.flex = "1";
    });
